...
class StoredTestZip64InSmallFiles(AbstractTestZip64InSmallFiles,
    ...
    def test_force_zip64(self):
        ...
        self.assertGreaterEqual(vers, zipfile.ZIP64_VERSION)
        ...
        self.assertEqual(cd_sig, b"PK\x01\x02")

        z = zipfile.ZipFile(io.BytesIO(zipdata))
        zinfos = z.infolist()
        self.assertEqual(len(zinfos), 1)
        self.assertGreaterEqual(zinfos[0].extract_version, zipfile.ZIP64_VERSION)
    ...
    def test_unseekable_zip_known_filesize(self):
        ...
        self.assertEqual(ex_id, 1)
        self.assertEqual(ex_len, 16)
        self.assertEqual(ex_usize, file_size)
        self.assertEqual(ex_csize, file_size)
        self.assertEqual(cd_sig, b"PK\x01\x02")
        ...
        self.assertGreaterEqual(vers, zipfile.ZIP64_VERSION)
        self.assertEqual(os, 0)
        self.assertEqual("{:b}".format(flags), "1000")
        self.assertEqual(comp, 0)
        self.assertEqual(csize, 0xFFFFFFFF)
        self.assertEqual(usize, 0xFFFFFFFF)
        self.assertEqual(fn_len, 8)
        ...
        self.assertEqual(ex_id, 1)
        self.assertEqual(ex_len, 16)
        self.assertEqual(ex_usize, 0)
        self.assertEqual(ex_csize, 0)
        self.assertEqual(dd_header, b"PK\07\x08")
        self.assertEqual(dd_usize, file_size)
        self.assertEqual(dd_csize, file_size)
        self.assertEqual(cd_sig, b"PK\x01\x02")
