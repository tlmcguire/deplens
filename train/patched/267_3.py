...
def _calculate_key2(password: bytes, cycles: int, salt: bytes, digest: str) -> bytes:
...
calculate_key = _calculate_key3 if platform.python_implementation() == "PyPy" or sys.version_info > (3, 6) else _calculate_key2
