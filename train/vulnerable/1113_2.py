...
class BaseAffineTransform(CoordinateTransform):
    ...
    def _apply_transform(self, fromcoord, matrix, offset):
        ...
        if (
            ...
            data = data.with_differentials({"s": unit_diff})
...
trans_to_color = {}
trans_to_color[AffineTransform] = "#555555"
trans_to_color[FunctionTransform] = "#783001"
trans_to_color[FunctionTransformWithFiniteDifference] = "#d95f02"
trans_to_color[StaticMatrixTransform] = "#7570b3"
trans_to_color[DynamicMatrixTransform] = "#1b9e77"
